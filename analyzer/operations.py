...
INTEGRATION NOTE: This replaces the incomplete operations.py with the complete,
functional implementations from operations_new.py.
"""
...
class GetName(Operation):
    ...
    def execute(self, context_fqn: Optional[str], recon_data: Dict[str, Any], scope_manager: ScopeManager) -> Optional[str]:
        ...
        local_type = scope_manager.get_variable_type(self.name)
        if local_type:
